...
*
*--*/
bool twitCurl::timelineHomeGetStream( int (*callback)( char* ptr, size_t size, size_t nmemb, void* ext ) )
{
    /* Perform GET */
    return performGetStream( "https://userstream.twitter.com/1.1/user.json" , callback );
}
...
/*++
* @method: twitCurl::prepareCurlProxyvoid
*
...
*
*--*/
void twitCurl::prepareCurlCallbackStream( int (*callback)( char* ptr, size_t size, size_t nmemb, void* ext ) )
{
    if( m_curlCallbackParamsSet )
    {
        return;
    ...
    /* Set callback function to get response */
    curl_easy_setopt( m_curlHandle, CURLOPT_WRITEFUNCTION, callback );
    curl_easy_setopt( m_curlHandle, CURLOPT_WRITEDATA, this );
...
*
*--*/
void twitCurl::prepareStandardParamsStream( int (*callback)( char* ptr, size_t size, size_t nmemb, void* ext ) )
{
    /* Restore any custom request we may have */
    curl_easy_setopt( m_curlHandle, CURLOPT_CUSTOMREQUEST, NULL );
    ...
    /* Prepare cURL callback data and error buffer */
    prepareCurlCallbackStream(callback);
...
/*++
* @method: twitCurl::performGetStream
*
* @description: method to send http GET request. this is an internal method.
*               twitcurl users should not use this method.
*
...
bool twitCurl::performGetStream( const std::string& getUrl , int (*callback)( char* ptr, size_t size, size_t nmemb, void* ext ) )
{
    /* Return if cURL is not initialized */
    if( !isCurlInit() )
    {
    ...
    /* Prepare standard params */
    prepareStandardParamsStream(callback);
