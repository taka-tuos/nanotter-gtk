...
public:
    ...
    bool timelineHomeGetStream( int(*)(char*,size_t,size_t,void*) = (int(*)(char*,size_t,size_t,void*))curlCallback );
...
private:
    ...
    void prepareCurlCallbackStream(int (*)(char*,size_t,size_t,void*));
    void prepareCurlUserPass();
    void prepareStandardParams();
    void prepareStandardParamsStream(int (*)(char*,size_t,size_t,void*));
    bool performGet( const std::string& getUrl );
    bool performGetStream( const std::string& getUrl , int(*)(char*,size_t,size_t,void*) );
